/**
 * @file Internationalization : Stardew Valley Mod Translation Tool
 * @author bcmpinc
 */
...
/** Contains info about the running game.
 * This includes which mods are installed and which additional languages are in use.
 * Generated by `Info.cs`.
 */
const info = {};

/** The contents of iso639-1.json. Maps language codes to human readable names. */
const iso639_1 = {};

/** The translation tool's own language file. */
const language = {};

/**  Translation json parser. */
const TRANSLATION_PARSE_REGEX = new RegExp([
